...
public class DocumentoServiceImpl implements DocumentoService {
    ...
    public Map<String, Object> recibirDatos(String id) {
        ...
        if (optionalPracticante.isPresent()) {
            ...
            LocalDate fechaIngreso = LocalDate.parse(practicante.getFechaIngreso(), inputFormatter);
            LocalDate fechaSalida = LocalDate.parse(practicante.getFechaSalida(), inputFormatter);

            datos.put("fechaIngreso", fechaIngreso.format(formatter));
            datos.put("fechaSalida", fechaSalida.format(formatter));
            datos.put("fechaDocumento", LocalDate.now().format(formatter));
    ...
    public void enviarCarta(String email, String id) {
        ...
        String emailLiderArea = "c.aguilar.fcalma@gmail.com";
